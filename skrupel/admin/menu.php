...
<tr>
    ...
    <td><center><?php echo $lang['admin']['menu']['board']?></center></td>
    <td><center></center></td>
    <td><center></center></td>
    <td><center></center></td>
</tr>
...
<?php
if (@file_exists("../extend/bbc/admin.settings.php")) { ?>
   <td><table border="0" cellspacing="0" cellpadding="0">
     <tr><td><form name="formular"  method="post" action="../extend/bbc/admin.settings.php" target="rahmen12"></td>
     <td><input type="submit" name="bla" value="<?php echo $lang['admin']['menu']['bbc']?>" style="width:120px;"></td>
     <td></form></td></tr>
   </table></td>
<?php
} else { ?>
